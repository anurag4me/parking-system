  ...
  return (
    <>
      <main className="bg-gray-900 ">
            ...
            <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
              <div className="p-4 md:w-1/3 flex">
                ...
                <div className="flex-grow pl-6">
                  <h2 className="text-white-900 text-lg title-font font-medium mb-2">
        ...
        <section id="feedback" className="text-grey-600 body-font relative">
              ...
              <div className="p-4 md:w-1/2 w-full">
                <div className="h-full bg-gray-100 p-8 rounded">
                  <svg
                    ...
                    fill="currentColor"
                    className="block w-5 h-5 text-white-400 mb-4"
                  ...
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      <span className="title-font font-medium text-white-900">
                        Sarah M
                      </span>
            ...
            <div className="flex flex-wrap -m-4 text-center">
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <h2 className="title-font font-medium text-3xl text-white-900">
                    2.7K
                  </h2>
